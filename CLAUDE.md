...
## Testing
* **Test Helpers & Traits:** Mezzio-Inertia-specific testing traits live in `src/Testing/`. These are authored collaboratively and will grow over time. All standard quality tools (PHPStan, Pint) apply to this directory.
